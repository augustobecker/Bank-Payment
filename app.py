...
app = Chalice(app_name='Scheduled-Payment-System')

@app.route('/{table_name}/account/{accountID}', methods=['GET'], cors=True)
...
@app.route('/{table_name}/date/{schedualedDate}/status/{status}', methods=['GET'], cors=True)
...
@app.route('/{table_name}/schedualed_payments/account/{accountID}', methods=['GET'], cors=True)
...
@app.route('/{table_name}', methods=['POST'], cors=True)
...
@app.route('/{table_name}/account/{accountID}/payment/{paymentID}', methods=['PUT'], cors=True)
...
@app.route('/{table_name}/account/{accountID}/payment/{paymentID}', methods=['DELETE'], cors=True)
